...
public class Arithmetic {
    ...
    public static double divide(double dividend, double divisor, int scale, RoundingMode roundingMode) {
        return new BigDecimal(dividend).divide(new BigDecimal(divisor), scale, roundingMode).doubleValue();
    }
     ...
     * @param scale    保留几位，scale = 2 : 保留两位
     */
    public static double chu(double dividend, double divisor, int scale, RoundingMode roundingMode) {
        return divide(dividend, divisor, scale, roundingMode);
    }
