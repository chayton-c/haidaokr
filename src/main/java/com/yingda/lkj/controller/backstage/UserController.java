...
//        if (oldPassword.equals(user.getPassword()) && )
    ...
    public void exportUsers() throws Exception {
        ...
        Map<String, Object> params = new HashMap<>(Map.of("userName", Role.ADMIN, "sectionId", getSectionId()));
    ...
    public Json importLines(MultipartFile file) throws Exception {
        ...
        for (int i = 1; i < rowInfoMap.size(); i++) {
            ...
            List<Organization> workAreas = organizationClientService.getSlaves(workshop.getId());
