...
public class RailwayLineController extends BaseController {
    ...
    public Json getList() {
        ...
        for (RailwayLine railwayLine : railwayLines) {
            ...
            List<Station> stations = stationRailwayLineService.getStationsByRaiwayLineId(railwayLineId);
    ...
    @RequestMapping("/getAllRailwayLine")
    @ResponseBody
    public Json getAllRailwayLine() throws Exception {
        Map<String, Object> params = new HashMap<>();
        List<RailwayLine> railwayLines = railwayLineBaseService.findSQL(
                "SELECT id,`name` FROM railway_line",
                params,
                RailwayLine.class
        );
